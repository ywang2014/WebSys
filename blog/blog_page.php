		...
		<table border = 0 width = "80%" style = "border:1px solid #ddd; margin: 10px auto; overflow:scroll;">
			...
			if ($comments)
			{
				...
				{ ?>
					...
					<tr>
						<td style="height:100px;width:60px; border-right:1px solid #9af;">
			...
			<div >
				<form action = "comment_act.php" method = "post">
					<table width = "40%" style = "margin: 20px auto;">
						<tr>
							<td>
						...
						<tr>	
							<td align = "center">
								<input type = "submit" value = "回复" style = "width:100px; background-color:#aee;">
							</td>
						</tr>
					</table>
